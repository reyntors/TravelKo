...
const certifications = [
  {
    ...
    description:
      "License No: DOT-2024-TK-001234 Authorized travel agency license for domestic and international tour operations, valid until December 2025.",
  ...
  },
  {
    ...
    description:
      "TIN: 123-456-789-000 Registered business entity authorized to collect taxes and issue official receipts for tourism services.",
  ...
  },
  {
    ...
    description:
      "Registration No: CS202400987654 Corporate registration as TravelKo Travel Services Corporation, authorized to operate nationwide.",
...
function About() {
  ...
  return (
    <>
        ...
        >
          <Row>
            <Col xs="12" className="text-center text-white">
              ...
              >
                Connecting adventurers with experienced coordinators to create
                unforgettable travel experiences. Your trusted partner for
                adventure tours and premium travel gear.
              </p>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          ...
          <Row className="mb-5">
            <Col xs="12" className="text-center">
              ...
              >
                TravelKo is the Philippines' premier platform designed to bring
                together passionate travelers and experienced travel
                coordinators in one central location. We revolutionize how
                adventure enthusiasts discover, plan, and experience their dream
                journeys.
              </p>
              <p
                style={{
              ...
              >
                Founded with the vision of making adventure travel accessible to
                everyone, TravelKo provides a comprehensive ecosystem that
                includes tour booking, travel gear shopping, and secure payment
                solutions. We bridge the gap between wanderlust and reality.
              </p>
            </Col>
          </Row>
        ...
        <Container>
          <Row className="text-center mb-5">
            <Col>
              ...
              >
                Driving the future of adventure travel through innovation,
                safety, and exceptional experiences
              </p>
            </Col>
          </Row>
                ...
                >
                  <CardBody>
                    ...
                    <ul style={{ paddingLeft: "1.2rem", lineHeight: 1.6 }}>
                      {missionVisionData[activeIndex].points.map(
                        (point, idx) => (
                          <li key={idx}>{point}</li>
                        ),
                      )}
              ...
              {missionVisionData.map((_, index) => (
                <span
                  ...
                  style={{
                    ...
                    height: 12,
                    borderRadius: "50%",
                    background: activeIndex === index ? "#16A34A" : "#D1D5DB",
                    cursor: "pointer",
        ...
        <Container>
          <Row className="text-center mb-5">
            <Col>
              ...
              >
                The principles that guide every adventure and decision at
                TravelKo
              </p>
            </Col>
          </Row>
      ...
      <section className="py-5" style={{ fontFamily: "Poppins" }}>
        <Container>
          <Row className="justify-content-center text-center">
            <Col xs="12" md="10" lg="8">
              <h2 className="mb-3">Permits & Licenses</h2>
              <p className="mb-0">
                TravelKo operates under full legal compliance with all
                Philippine tourism and business regulations, ensuring safe and
                legitimate travel services for our customers.
              </p>
            </Col>
          </Row>
        </Container>
      ...
      <section className="pb-5" style={{ fontFamily: "Poppins" }}>
        <Container>
        ...
        <Container>
          <Row className="text-center mb-5">
            <Col>
              ...
              >
                Comprehensive insurance protection to ensure safety,
          ...
          <Row className="text-center mb-5">
            <Col>
              ...
              >
                All permits and licenses are regularly renewed and updated. For
                verification of any certification, please contact our customer
                serivce team.
              </p>
            </Col>
          </Row>
